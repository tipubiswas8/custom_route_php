    ...
    <form action="{{ route('module-link-create') }}" method="get">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-label" for="module_id">Parent Module: <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="url" type="text" name="url" class="form-control" @required(true) placeholder="Ex: payroll/report/salary/edit/{id}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="method">Method: <span class="text-danger">*</span></label>
                            <input id="method" type="text" name="method" class="form-control" @required(true) placeholder="Ex: salaryEdit">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="controller" type="text" name="controller" class="form-control" @required(true) placeholder="Ex: Salary Controller"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="model" type="text" name="model" class="form-control" placeholder="Ex: Salary Model"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="migration" type="text" name="migration" class="form-control" placeholder="Ex: salarys table"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="seeder" type="text" name="seeder" class="form-control" placeholder="Ex: Salary Seedre"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="name" type="text" name="name" class="form-control" placeholder="Name for controller, model, migration, seeder and view"/>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
